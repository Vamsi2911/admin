...
else if ($_SESSION['hid']!="") {
    $qid = $_SESSION['hid'];
}

$result = mysqli_query($con, "select * from hostel_accommodation where id='".$qid."' ");
...
$pdf->Image('../images/veda acom.jpg',0,0,210);
...
//rupee icon image
$pdf->Image('../icons/rupee-icon.png',48+strlen($fetch['fee']),64,1.7);
...
//college
$pdf->setXY(149,46.4);
$pdf->Cell(0,0,substr($fetch['college'], 0, 26));
...
//rupee icon image
$pdf->Image('../icons/rupee-icon.png',154+strlen($fetch['fee']),51.3,1.7);
