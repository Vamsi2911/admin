...
<head>
    ...
    <title>Accommodation Students</title>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Hostel Registrations</a>
                </div>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Hostel Student Registrations List</h4><br/>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped" id="datatable" style="background-color: #fff;">
                                    ...
                                    <tbody>
                                        <?php
                                            $count = 1;
                                            $sel_query = "Select * from hostel_accommodation where added_by = '".$_SESSION['username']."' ORDER BY id desc;";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="hostel_receipt/?print.php=<?php echo base64_encode($row1['id']); ?>" target="_blank"><label class="label label-danger" data-toggle="tooltip" title="print" data-placement="right" style="cursor: pointer;"><i class="fa fa-print fw" style="color: #fff;"></i></label></a></td>
                                        </tr>
                                        <?php $count++; } ?>
                                    </tbody>
                                </table>
